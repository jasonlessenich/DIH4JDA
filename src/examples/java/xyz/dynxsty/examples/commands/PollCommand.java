...
//This is the principle that all other component handlers follows.
public class PollCommand extends SlashCommand implements ButtonHandler {
    ...
    public PollCommand() {
        ...
        setCommandCooldown(Duration.of(1, ChronoUnit.MINUTES)); //Added cooldown to prevent spam by users
    }
    ...
    public void handleButton(@NotNull ButtonInteractionEvent event, @NotNull Button button) {
        //Handles the buttons -> have to be used in combination with
